...
var Editor = {
    ...
    saveFile: function () {
        ...
        debugger;
        var recordeDto = {};
        recordeDto.content = r.source;
        $.ajax({
            type: 'POST',
            url: "http://localhost:52718//api//Request//AddNewRecorde",
            data: JSON.stringify(recordeDto),
            contentType: 'application/json; charset=utf-8',
            dataType: 'json',
            success: function (id) {
                console.log(id);
                window.open( "http://localhost:4200?contentId="+id);
                return true;
            },
            error: function(data){
                console.log(data);
